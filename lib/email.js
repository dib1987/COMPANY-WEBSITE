...
const BRAND = "Bharat AI Automation Labs";
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:14px;overflow:hidden;border:1px solid #e3e6ed;">
        <tr><td style="background:#0b1020;padding:22px 28px;">
          <span style="color:#ffffff;font-size:18px;font-weight:bold;letter-spacing:-0.3px;">Bharat AI <span style="color:#2b59ff;">Automation Labs</span></span>
        </td></tr>
...
export function autoReplyEmail({ name, company_name, industry, company_size, problem }) {
  ...
  const text = [
    ...
    ``,
    `(Tip: if this landed in Promotions or Spam, drag it into your Inbox so you don't miss our reply.)`,
    ``,
    ...
    ``,
    `Our team will communicate with you over email before setting up a 30-minute call to understand your bottlenecks in detail.`,
    ``,
    `Talk soon,`,
    SIGNOFF_NAME,
    SIGNOFF_FULL,
  ...
  const inner = `
    ...
    <p style="margin:0 0 14px;font-size:13px;line-height:1.5;color:#5b6478;">Tip: if this landed in Promotions or Spam, drag it into your Inbox so you don't miss our reply.</p>
    ...
    <p style="margin:0 0 22px;font-size:15px;line-height:1.55;color:#33384a;">Our team will communicate with you over email before setting up a 30-minute call to understand your bottlenecks in detail.</p>
    ${sig}`;
